    ...
    return (
        <>
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-md-6 col-lg-5 col-12 ft-1">
                            <h3><span>Book</span>Crafted</h3>
                            <p>Discover, Explore, and Immerse Yourself in the World of Literature with BookCrafted – Your Premier Destination for Exceptional Books</p>
            ...
            <div className='Last-footer'>
                <p className="col-sm">
                    &copy;{new Date().getFullYear()} BookCrafted | All rights reserved
                </p>
            </div>
        </>
    )
